...
@app.route('/user')
@login_required  # Se proteje lae ruta para que solo los usuarios autenticados puedan acceder
def usuario():
...
def productosA(): 
    ...
    return render_template("admin/productosA.html",productos=productos)
...
def productosB(): 
    ...
    return render_template("user/productosB.html",productos=productos)
#----------------------------------
...
def buscar_productos():
    if request.method == 'POST':
        ...
        # Consulta a la base de datos para buscar productos 
        cur = mysql.connection.cursor()
...
def descargar_productos():
    ...
    # Escribir los encabezados del archivo excel
    ...
    # Descarga de archivo excel para el usuario
...
def transacciones():
    ...
    return render_template('admin/transacciones.html', productos=productos, transacciones=transacciones)
...
def transaccionesB():
    ...
    return render_template('user/transaccionesB.html', productos=productos, transacciones=transacciones)
